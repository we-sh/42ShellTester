...
*[spec > 21sh > redirections > outputs > truncating > multiple](..) > 002-together-stdout-first*
...
```bash
./write_on_stdout_and_stderr ${GLOBAL_TOKEN}_1 ${GLOBAL_TOKEN}_2 1>new_file_stderr_and_stdout 2>&1
...
```bash
expected_to create_file "new_file_stderr_and_stdout" matching_regex "${GLOBAL_TOKEN}_1$"
expected_to create_file "new_file_stderr_and_stdout" matching_regex "${GLOBAL_TOKEN}_2$"
