...
*[spec > 42sh > builtins > export](..) > 006-export-update-env-variable*
...
```bash
export ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE1
export ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE2
./display_env
...
```bash
expected_to_not match_regex "${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE1"
expected_to match_regex "${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE2"
