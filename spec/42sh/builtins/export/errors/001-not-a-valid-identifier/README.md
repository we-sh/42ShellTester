# 001-not-a-valid-identifier

*[spec > 42sh > builtins > export > errors](..) > 001-not-a-valid-identifier*

The purpose of this test is to check that using the builtin `export` with an invalid identifier results in an error and a failure exit status.
