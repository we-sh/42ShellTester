# 001-export-and-tmp-env-part1

*[spec > 42sh > builtins > export > mixed](..) > 001-export-and-tmp-env-part1*
...
```bash
${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE export ${GLOBAL_TOKEN}_NAME
export
