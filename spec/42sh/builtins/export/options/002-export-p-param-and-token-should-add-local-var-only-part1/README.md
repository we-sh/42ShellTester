# 002-export-p-param-and-token-should-add-local-var-only-part1

*[spec > 42sh > builtins > export > options](..) > 002-export-p-param-and-token-should-add-local-var-only-part1*
