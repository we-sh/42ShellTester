# 003-export-p-param-and-token-should-add-local-var-only-part2

*[spec > 42sh > builtins > export > options](..) > 003-export-p-param-and-token-should-add-local-var-only-part2*
...
expected_to_not match_regex "${GLOBAL_TOKEN}_NAME"
