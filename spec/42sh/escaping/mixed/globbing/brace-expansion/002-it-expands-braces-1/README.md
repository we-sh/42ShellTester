# 002-it-expands-braces-1

*[spec > 42sh > escaping > mixed > globbing > brace-expansion](..) > 002-it-expands-braces-1*
...
```bash
./write_all_arguments_on_stdout \\{1..2}
