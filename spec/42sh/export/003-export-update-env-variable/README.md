# 003-export-update-env-variable

*[spec > 42sh > export](..) > 003-export-update-env-variable*

The purpose of this test is to check if updating an environment variable works with export.
### Shell commands that are sent to the standard entry

```bash
export ${GLOBAL_TOKEN}=1
export ${GLOBAL_TOKEN}=2
env
...
```bash
expected_to match_regex "${GLOBAL_TOKEN}=2"
