# 004-simple-descending-1

*[spec > 42sh > globbing > brace-expansion > ascii-range](..) > 004-simple-descending-1*
...
```bash
./write_all_arguments_on_stdout {E..A}
...
```bash
expected_to match_regex "^E@D@C@B@A@$"
