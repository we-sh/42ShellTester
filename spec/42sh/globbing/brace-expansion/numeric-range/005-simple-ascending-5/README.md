...
*[spec > 42sh > globbing > brace-expansion > numeric-range](..) > 005-simple-ascending-5*
...
```bash
./write_all_arguments_on_stdout {-100..-98}${GLOBAL_TOKEN}
...
```bash
expected_to match_regex "^-100${GLOBAL_TOKEN}@-99${GLOBAL_TOKEN}@-98${GLOBAL_TOKEN}@$"
