...
*[spec > 42sh > globbing > brace-expansion > numeric-range](..) > 010-simple-descending-5*
...
```bash
./write_all_arguments_on_stdout {-98..-100}${GLOBAL_TOKEN}
...
```bash
expected_to match_regex "^-98${GLOBAL_TOKEN}@-99${GLOBAL_TOKEN}@-100${GLOBAL_TOKEN}@$"
