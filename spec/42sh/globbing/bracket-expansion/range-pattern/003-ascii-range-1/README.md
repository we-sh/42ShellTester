...
*[spec > 42sh > globbing > bracket-expansion > range-pattern](..) > 003-ascii-range-1*
...
The other use the ascii value, which does make more sense.### What is done before test
...
```bash
${GLOBAL_TMP_DIRECTORY}/write_all_arguments_on_stdout []-z]
