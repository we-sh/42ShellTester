...
*[spec > 42sh > globbing > bracket-expansion > range-pattern](..) > 004-ascii-range-2*
...
```bash
${GLOBAL_TMP_DIRECTORY}/write_all_arguments_on_stdout [1-z]
...
expected_to_not match_regex "1-z@"
expected_to_not match_regex "[[]1-z]@"

might match_regex "^2@B@Z@[[]@]@a@c@$"
