...
*[spec > 42sh > local-variable](..) > 001-declare-and-expand-1*

The purpose of this test is to check that declaring and expanding a local variable does work.
### Shell commands that are sent to the standard entry

```bash
${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE
./write_on_stdout_and_stderr $${GLOBAL_TOKEN}_NAME $${GLOBAL_TOKEN}_NAME
