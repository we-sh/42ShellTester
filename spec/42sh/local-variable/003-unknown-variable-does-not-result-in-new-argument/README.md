...
*[spec > 42sh > local-variable](..) > 003-unknown-variable-does-not-result-in-new-argument*
...
```bash
./write_on_stdout $${GLOBAL_TOKEN}_UNKNOWN ${GLOBAL_TOKEN}_DISPLAYED
