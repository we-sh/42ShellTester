...
```bash
${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE1 ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE2 ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE3
...
```bash
expected_to_not match_regex "^${GLOBAL_TOKEN}_VALUE1$"
