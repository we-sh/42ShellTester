# 001-local-variable-shouldnt-be-set

*[spec > 42sh > local-variable > mixed > inline-environment-variable](..) > 001-local-variable-shouldnt-be-set*
...
expected_to match_regex "write on stderr"
