...
*[spec > 42sh > local-variable > mixed > redirections](..) > 003-reading*
...
echo "${GLOBAL_TOKEN}_VALUE" > "${GLOBAL_TOKEN}_FILENAME"
...
./read_on_stdin < $${GLOBAL_TOKEN}_NAME
...
```bash
expected_to match_regex "^${GLOBAL_TOKEN}_VALUE@$"
