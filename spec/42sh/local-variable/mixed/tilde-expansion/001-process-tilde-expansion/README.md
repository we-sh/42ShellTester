# 001-process-tilde-expansion

*[spec > 42sh > local-variable > mixed > tilde-expansion](..) > 001-process-tilde-expansion*
...
```bash
${GLOBAL_TOKEN}=~
./write_on_stdout TILDE:$${GLOBAL_TOKEN}
...
```bash
expected_to_not match_regex "TILDE:~"
might match_regex "TILDE:/${GLOBAL_TOKEN}"
