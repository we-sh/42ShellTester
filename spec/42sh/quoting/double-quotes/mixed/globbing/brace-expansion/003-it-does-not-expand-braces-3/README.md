# 003-it-does-not-expand-braces-3

*[spec > 42sh > quoting > double-quotes > mixed > globbing > brace-expansion](..) > 003-it-does-not-expand-braces-3*
...
```bash
expected_to match_regex "[{]1..2}1@[{]1..2}2@"
