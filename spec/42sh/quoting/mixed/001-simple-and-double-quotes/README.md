...
*[spec > 42sh > quoting > mixed](..) > 001-simple-and-double-quotes*
...
```bash
./write_on_stdout_and_stderr "ABCD'EFG"HI'J"KL"'MNO'P"' Q"RS'T'U''"VW'X"Y'Z
...
```bash
expected_to match_regex "ABCD'EFGHIJ\"KL\"MNOP"
