# 002-it-does-not-expand-braces-2

*[spec > 42sh > quoting > simple-quotes > mixed > globbing > brace-expansion](..) > 002-it-does-not-expand-braces-2*
...
```bash
./write_all_arguments_on_stdout {1..2}'{1..2}'
...
```bash
expected_to match_regex "1[{]1..2}@2[{]1..2}@"
