...
*[spec > 42sh > subshell](..) > 003-multiline*
...
```bash
(
./write_on_stdout ${GLOBAL_TOKEN}_SUBSHELL1 ;
./write_on_stdout ${GLOBAL_TOKEN}_SUBSHELL2
)
...
```bash
expected_to match_regex "${GLOBAL_TOKEN}_SUBSHELL1"
expected_to match_regex "${GLOBAL_TOKEN}_SUBSHELL2"
