# 001-it-does-not-modify-parent-environment

*[spec > 42sh > subshell > mixed > builtins > setenv](..) > 001-it-does-not-modify-parent-environment*
...
```bash
(setenv ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE ; setenv ${GLOBAL_TOKEN}_NAME ${GLOBAL_TOKEN}_VALUE ; export ${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE)
./display_env
...
```bash
expected_to_not match_regex "${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE"
