# 001-modifies-the-child-environment-only-1

*[spec > 42sh > subshell > mixed > inline-environment-variable](..) > 001-modifies-the-child-environment-only-1*
...
```bash
(${GLOBAL_TOKEN}_NAME=${GLOBAL_TOKEN}_VALUE ./display_env)
./display_env
