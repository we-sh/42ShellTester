...
*[spec > bonuses > builtins > fold > errors](..) > 003-invalid-width-3*

The purpose of this tests is to check that using the builtin `fold` with an invalid width results in an error.
### Shell commands that are sent to the standard entry

```bash
./write_on_stdout 123 | fold -w abc
...
might match_regex "illegal width value"
