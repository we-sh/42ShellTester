...
*[spec > bonuses > builtins > fold > errors](..) > 005-invalid-file-2*

The purpose of this tests is to check that using the builtin `fold` with an invalid file results in an error.
