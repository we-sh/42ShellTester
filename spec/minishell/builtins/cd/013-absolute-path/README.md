...
*[spec > minishell > builtins > cd](..) > 013-absolute-path*
...
```bash
rm -rf "./my_sub_directory"
mkdir -p "./my_sub_directory/and_another_one/"
...
```bash
cd ${GLOBAL_TMP_DIRECTORY}/my_sub_directory/and_another_one
...
```bash
expected_to match_regex "PWD:${GLOBAL_TMP_DIRECTORY}/my_sub_directory/and_another_one:PWD"
expected_to match_regex "^PWD=${GLOBAL_TMP_DIRECTORY}/my_sub_directory/and_another_one$"
