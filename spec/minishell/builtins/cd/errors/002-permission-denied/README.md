...
The purpose of this test is to check if cd throw an error when we are using a folder without permission as argument.
...
might match_regex "[Pp]ermission denied"
