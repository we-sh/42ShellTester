...
The purpose of this test is to check if cd throw an error when we are passing an infinite loop of symbolic link as argument.
...
might match_regex "[Tt]oo many symbolic links encountered"
